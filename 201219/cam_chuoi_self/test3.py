...
model = tf.keras.models.load_model('/home/ivsr/CV_Group/cam_chuoi_self/model_keras_3.h5')
model.load_weights('/home/ivsr/CV_Group/cam_chuoi_self/model_weights_3.h5')

test_dir = '/home/ivsr/CV_Group/cam_chuoi_self/test3'
test_images= ['/home/ivsr/CV_Group/cam_chuoi_self/test3/{}'.format(i) for i in os.listdir(test_dir)]
...
class_name= ['orange', 'banana_bunch','mangostan']
a=len(test_images)
print(a)
