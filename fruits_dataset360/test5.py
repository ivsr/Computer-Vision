...
model = tf.keras.models.load_model('/home/ivsr/CV_Group/2_fruits/model_keras_41.h5')
model.load_weights('/home/ivsr/CV_Group/2_fruits/model_weights_41.h5')


test_dir = '/home/ivsr/CV_Group/2_fruits/test5'
test_images = ['/home/ivsr/CV_Group/2_fruits/test5/{}'.format(i) for i in os.listdir(test_dir)]
a=len(test_images)
print(a)
...
class_name= ['apple', 'banana', 'Avocado', 'Mangostan']
t=len(class_name)
nrows = 50
ncolumns = 50
channels = 3
