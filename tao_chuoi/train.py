...
apple_dir = '/home/ivsr/CV_Group/tao_chuoi/create_green_apple'
banana_dir = '/home/ivsr/CV_Group/tao_chuoi/banana_bunch'
apple_imgs = ['/home/ivsr/CV_Group/tao_chuoi/create_green_apple/{}'.format(i) for i in os.listdir(apple_dir) if 'green_apple' in i]
banana_imgs = ['/home/ivsr/CV_Group/tao_chuoi/banana_bunch/{}'.format(i) for i in os.listdir(banana_dir) if 'banana_bunch' in i]
...
class_name= ['green_apple', 'banana_bunch']
...
for batch in test_datagen.flow(X, batch_size=1):
    ...
    print(pred)
    if pred > 0.5:
        text_labels.append('a banana bunch ')
    else:
        text_labels.append('an green apple')
